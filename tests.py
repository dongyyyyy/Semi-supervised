...
def main():
    ...
    global best_acc
    saved_file = args.out + f'fixmatch_{args.arch}_{args.num_labeled}_{args.imbalanced_ratio}_{args.seed}.model_best.pth.tar'
    ...
    print("***** Training Distribution Information *****")
    print(f"Labeled Distribution ==> \n{counts_elements_labeled}")
    print(f"Unlabeled Distribution ==> \n{counts_elements_unlabeled}")
    # exit(1)
